...
import { of } from 'rxjs';
import { map, mapTo, flatMap, mergeMap, catchError } from 'rxjs/operators';
import { combineEpics, ofType } from 'redux-observable';

import { keys as areaCreationKeys, events as areaCreationEvents } from './constants';
import { events as mapZoneEvents } from '../mapLayerZone/constants';
...
// const areaConfigurator = (zone, props, geo) => JSON.stringify({
//   class: 'MapEntity',
