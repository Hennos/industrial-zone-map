...
export const publishChangesCadastrialArea = area => ({
  type: events.publishChangesCadastrialArea,
  area
});
export const saveChangesCadastrialArea = area => ({
  type: events.saveChangesCadastrialArea,
  area
});
export const removeCadastrialArea = area => ({
...
export const updateAreaPropertyValue = (name, value) => ({
...
export const setAreaPropertiesValue = area => ({
...
export const requestLoadAreaPropertiesValue = area => ({
  type: events.requestLoadAreaPropertiesValue,
  area
});
export const loadAreaPropertiesValue = area => ({
  type: events.loadAreaPropertiesValue,
  area
});
export const successLoadAreaPropertiesValue = data => ({
  type: events.successLoadAreaPropertiesValue,
  data
});
export const errorLoadAreaPropertiesValue = error => ({
  type: events.errorLoadAreaPropertiesValue,
  error
});

export const requestPublishCadastrialArea = area => ({
  type: events.requestPublishCadastrialArea,
  area
});

export const requestModifyAreaProps = area => ({
  type: events.requestModifyAreaProps,
  area
});

export const requestModifyAreaPhoto = area => ({
  type: events.requestModifyAreaPhoto,
  area
});

export const successPublishCadastrialArea = response => ({
  type: events.successPublishCadastrialArea,
  response
});
export const errorPublishCadastrialArea = error => ({
  type: events.errorPublishCadastrialArea,
  error
});

export const requestRemoveCadastrialArea = area => ({
  type: events.requestRemoveCadastrialArea,
  area
});
export const successRemoveCadastrialArea = response => ({
  type: events.successRemoveCadastrialArea,
  response
});
export const errorRemoveCadastrialArea = error => ({
